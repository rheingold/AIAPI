 ...
 */
export class OSEnforcementChecker {
     ...
     */
    async checkEnforcementActive(): Promise<{ active: boolean; details: string }> {
        try {
     ...
     */
    private async checkWDAC(): Promise<{ enabled: boolean; details: string }> {
        try {
            const script = `
     ...
     */
    private async checkAppLocker(): Promise<{ enabled: boolean; details: string }> {
        try {
            const script = `
    ...
    ): Promise<{ valid: boolean; signed: boolean; trusted: boolean; thumbprint?: string; details: string }> {
     ...
     */
    async isCertificateTrusted(thumbprint: string): Promise<{ trusted: boolean; details: string }> {
        try {
            const script = `
